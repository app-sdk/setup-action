...
const ruleset_1 = __webpack_require__(7371);
...
var middlewareUserAgent = __webpack_require__(511);
...
var httpAuthSchemeProvider = __webpack_require__(9388);
var runtimeConfig = __webpack_require__(9861);
...
const package_json_1 = tslib_1.__importDefault(__webpack_require__(1150));
const core_1 = __webpack_require__(8439);
...
const runtimeConfig_shared_1 = __webpack_require__(9098);
...
const httpAuthSchemeProvider_1 = __webpack_require__(9388);
const endpointResolver_1 = __webpack_require__(1938);
const getRuntimeConfig = (config) => {
    return {
...
var client = __webpack_require__(4335);
var tokenProviders = __webpack_require__(1695);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(942); });
    const sso = ssoClient ||
...
var clientSso = __webpack_require__(5539);
...
var client = __webpack_require__(4335);
var httpAuthSchemes = __webpack_require__(2490);
var propertyProvider = __webpack_require__(4200);
var sharedIniFileLoader = __webpack_require__(5285);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 9).then(__webpack_require__.t.bind(__webpack_require__, 7390, 19));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 9).then(__webpack_require__.t.bind(__webpack_require__, 7390, 19));
